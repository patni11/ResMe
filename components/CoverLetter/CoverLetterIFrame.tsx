...
const CoverLetterIFrame = ({
  ...
  const totalHeight = singlePageHeight; // Total height for all pages
  ...
  return (
    <div
      style={{
        ...
        position: "relative",
        maxWidth: `${width}px`,
        maxHeight: `${singlePageHeight}px`,
      }}
      className={`example overflow-x-hidden bg-white`}
    >
      <div
        style={{
          width: `${width}px`,
          height: `${totalHeight}px`, // Height to include all pages
 ...
 */
export const CoverLetterIFrameCSR = dynamic(
  () => Promise.resolve(CoverLetterIFrame),
  {
    ssr: false,
  }
);
