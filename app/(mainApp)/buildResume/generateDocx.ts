...
import { EducationType, Certificate } from "../education/pageTypes";
import { Experience } from "../experience/pageTypes";
...
type ResumeType = {
  educations?: Omit<EducationType, "_id">[];
          ...
          children: [
            ...
            ...(educations ?? [])
              .map((education) => {
                ...
                arr.push(
                  this.createRoleText(
                    `${education.major} - ${education.degreeType}`
                  )
                );
            ...
            ...(experiences ?? [])
              .map((experience) => {
                ...
                arr.push(this.createRoleText(experience.positionTitle));
