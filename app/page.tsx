        ...
        <div className="mt-8 ml-0 md:mt-0 w-full md:w-[60%]">
          <Accordion type="single" collapsible>
            ...
            <AccordionItem value="item-6">
              ...
              <AccordionContent>
                No, we do not offer refunds, but you can cancel subscription for
                next month. Note: Other than your most recent 3 resumes, rest
                would get deleted as they are not available in free plan.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
