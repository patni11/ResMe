      ...
      <section className="w-[80%] my-24 mx-auto">
        <Card>
          ...
          <CardContent className="flex flex-col space-y-4">
            <p className="font-bold text-2xl">Welcome to ResMe!</p>

            <p>
              These terms and conditions outline the rules and regulations for
              the use of ResMe's Website, located at https://www.resme.xyz/.
            </p>

            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use ResMe if you do not agree to
            ...
            <p>
              We employ the use of cookies. By accessing ResMe, you agreed to
              use cookies in agreement with the ResMe's Privacy Policy.{" "}
            </p>
            ...
            <p>
              Unless otherwise stated, ResMe and/or its licensors own the
              intellectual property rights for all material on ResMe. All
              intellectual property rights are reserved. You may access this
              from ResMe for your own personal use subjected to restrictions set
              in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
              <li>Republish material from ResMe</li>
              <li>Sell, rent or sub-license material from ResMe</li>
              <li>Reproduce, duplicate or copy material from ResMe</li>
              <li>Redistribute content from ResMe</li>
            </ul>
            ...
            <p>
              ...
              ResMe does not filter, edit, publish or review Comments prior to
              their presence on the website. Comments do not reflect the views
              and opinions of ResMe,its agents and/or affiliates. Comments
              reflect the views and opinions of the person who post their views
              and opinions. To the extent permitted by applicable laws, ResMe
            ...
            <p>
              ResMe reserves the right to monitor all Comments and to remove any
            ...
            <p>
              You hereby grant ResMe a non-exclusive license to use, reproduce,
            ...
            <p>
              ...
              ResMe; and (d) the link is in the context of general resource
              information.
            </p>
            ...
            <p>
              ...
              by sending an e-mail to ResMe. Please include your name, your
            ...
            <p>
              No use of ResMe's logo or other artwork will be allowed for
